...
Importer jest dostępny w zakładce Log. Analizuje TCX lokalnie, pokazuje podgląd, dopasowuje sesję po `Session_ID` i sprawdza konflikty. Obsługuje pojedynczy cel HR (v1), etapowy cel czasowy (v2) oraz etapowy cel dystansowy z `DistanceMeters` (v3); może też uzupełnić brakującą godzinę sesji. Zakres zapisu i granice idempotencji: [`docs/tcx-import.md`](docs/tcx-import.md).

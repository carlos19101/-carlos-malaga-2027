...
export const A = {
  ...
  rawBodyBatteryGain: ['bodybattery gain'],
  rawReadiness: ['readiness garmin'],
  rawPain: ['pain 0 10'],
  rawDoms: ['doms 0 10'],
  rawFatigue: ['fatigue 0 10'],
  rawCoachStatus: ['coach status'],
  rawCoachDecision: ['coach decision'],
  rawSource: ['source'],
  rawBodyBatteryCurrent: ['bodybattery current'],
  ...
  logSrpe: ['srpe'],
  logPain: ['pain'],
  logLegFatigue: ['leg fatigue 0 10'],
  ...
  logFeedbackSyncedAt: ['feedback synced at'],
...
export const SHEET_CONTRACTS = {
  ...
  'Training Log': [
    ...
    requirement('logFeedbackNotes', 'Feedback_Notes'),
    requirement('logFeedbackSyncedAt', 'Feedback_Synced_At'),
  ],
  Plan: [
  ...
  Raw_Data: [
    ...
    requirement('rawBodyBatteryGain', 'BodyBattery_gain'),
    requirement('rawReadiness', 'Readiness_Garmin'),
    requirement('rawPain', 'Pain_0_10'),
    requirement('rawDoms', 'DOMS_0_10'),
    requirement('rawFatigue', 'Fatigue_0_10'),
    requirement('rawCoachStatus', 'Coach_Status'),
    requirement('rawCoachDecision', 'Coach_Decision'),
    requirement('rawSource', 'Source'),
    requirement('rawBodyBatteryCurrent', 'BodyBattery_current'),
  ],
};
